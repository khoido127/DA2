        ...
        <div class="content-bill row no-margin">
            ...
            <div class="col-md-7">
                <div class="button-group col-md-12 tx-al-r">
                    <div class="row no-margin mg-b-10">
                        <label class="edit-label">Size: </label>
                        <input class="edit-field" onclick="clearText()" id="sizeNew" type="text" value="" placeHolder="Input size"/>
                    </div>
                    <div class="row no-margin mg-b-10">
                        <label class="edit-label">Quantity: </label>
                        <input class="edit-field" id="slNew" type="number" value="" />
                        <br />
